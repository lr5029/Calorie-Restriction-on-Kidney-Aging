setwd("GSE137869_RAW") #Folder with all samples, each sample a separate sub-folder)
library(Seurat)
library(dplyr)
library(Matrix)
library(patchwork)
...
a1.data<-Read10X(data.dir ="./GSM4331828/") # this sub-folder contains GSM4331828_Kidney-M-Y_barcodes.tsv, GSM4331828_Kidney-M-Y_genes.tsv, and GSM4331828_Kidney-M-Y_matrix.mtx
...
for (i in seq_along(projects)){
  temp.data<-Read10X(data.dir=paste("./",projects[i],sep="")) #read a new sample data
